...
class ViewController: NSViewController {
	...
	fileprivate var puzzles: [Puzzle.Type] = [Puzzle1_1.self, Puzzle1_2.self, Puzzle2_1.self, Puzzle2_2.self, Puzzle3_1.self, Puzzle3_2.self, Puzzle4_1.self, Puzzle4_2.self, Puzzle5_1.self, Puzzle5_2.self]
